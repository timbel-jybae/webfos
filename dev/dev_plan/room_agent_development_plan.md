...
| 모듈 | 상태 | 설명 |
|------|------|------|
| VideoRouter | ⚠️ 미사용 | 서버 측 버퍼링 메모리 이슈로 비활성화 |
...
| Phase 2 | 영상 지연 | VideoRouter, FrameRingBuffer |
...
| 리스크 | 영향 | 대응 방안 |
|--------|------|----------|
| livekit-agents 프레임 버퍼링 성능 | 지연 트랙 품질 저하 | 프로파일링 후 최적화, 대안 검토 |
...
### Phase 2: VideoRouter
- [x] FrameRingBuffer 구현
- [x] FrameRingBuffer 단위 테스트
- [x] VideoRouter 구현
- [x] VideoRouter 단위 테스트
- [x] RoomAgent 통합
